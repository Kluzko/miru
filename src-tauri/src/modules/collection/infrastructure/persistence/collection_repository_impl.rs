...
use crate::modules::anime::domain::{
    ...
    value_objects::{AnimeTitle, QualityMetrics},
};
use crate::modules::anime::infrastructure::models::{
    Anime, AnimeGenre, AnimeStudio, GenreModel, QualityMetricsModel, StudioModel,
};
use crate::modules::collection::infrastructure::models::{
    CollectionAnime as CollectionAnimeModel, CollectionAnimeChangeset, CollectionChangeset,
    CollectionModel, NewCollection, NewCollectionAnime,
};
use crate::modules::collection::{Collection, CollectionAnime, CollectionRepository};
use crate::modules::provider::domain::{AnimeProvider, ProviderMetadata};
use crate::schema::{
    anime, anime_genres, anime_studios, collection_anime, collections, genres, studios,
};
